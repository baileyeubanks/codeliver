...
const SOURCE_OPERATION_CONTRACTS = [
  ...
  },
  {
    ...
    note: "Operator-managed outside Co-Production Pro; no shell or command execution is exposed.",
  },
  {
    id: "worker-handoff",
  ...
  return (
    <div className={styles.panel}>
      <SettingsSection
        ...
        detail="Dense production infrastructure controls for Co-Production Pro. Planned capabilities stay disabled until their backend contract, permission, and audit path exist."
        action={
