  ...
  return (
    ...
    >
      ...
      <header className="cockpit-header">
        <Link className="cockpit-brand" href={demoMode ? "/projects?demo=1" : "/projects"} aria-label="Co-Production Pro projects">
          <CoProductionBrand className={styles.brandLockup} priority />
          <CoProductionBrand className={styles.brandMark} variant="compact-mark" label="Co-Production Pro" />
        </Link>
        ...
        <div className="cockpit-upload-overlay" role="presentation">
          ...
          >
            ...
            <div className="cockpit-upload-progress-copy">
              <span>{uploadStatus.message ?? "Keep this window open while Co-Production Pro prepares the review asset."}</span>
