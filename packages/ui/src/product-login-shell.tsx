...
export function ProductLoginShell({
  ...
  const displayProductLabel = theme.displayLabel ?? productLabel;
  const { prefix, suffix } = splitLabel(displayProductLabel);
