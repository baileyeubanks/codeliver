...
export default function BrandSettings({
  ...
  const brandReadiness = [
    ...
    {
      label: "Review portal",
      value: values.displayName || "Inherited brand",
      detail: values.playerLabel || "Inherited player label",
      icon: MonitorPlay,
      tone: "good",
    },
    {
      label: "Governance",
      value: canManage ? "Authorized" : "Read-only",
      detail: demoMode ? "Local draft and publish controls" : "Managed service required",
      icon: ShieldCheck,
      tone: canManage ? "good" : "warn",
    },
    {
      label: "Custom upload",
      value: "Backend gated",
      detail: "Tenant storage and scan required",
      icon: UploadCloud,
      tone: "warn",
    },
  ];
  ...
  return (
    <div className={styles.panel}>
      <SettingsSection
        title="Brand inheritance"
        detail="Platform defaults flow into the organization, then the active workspace."
        action={
      ...
      >
        <div className={styles.brandReadinessStrip} aria-label="Brand readiness">
          {brandReadiness.map((item) => {
            const Icon = item.icon;
            return (
              <article
                className={`${styles.brandReadinessItem} ${
                  item.tone === "good" ? styles.brandReadinessGood : styles.brandReadinessWarn
                }`}
                key={item.label}
              >
                <span className={styles.brandReadinessIcon} aria-hidden="true">
                  <Icon size={15} />
                </span>
                <span className={styles.brandReadinessCopy}>
        ...
        <div className={styles.brandGrid} style={{ marginTop: 18 }}>
          <form className={styles.brandEditor} onSubmit={saveDraft}>
              ...
              <div className={styles.field}>
                ...
                <div className={styles.colorInputRow}>
                  <input
                    ...
                    type="color"
                    value={normalizeHexColor(values.primaryColor) ?? "#0057ff"}
            ...
            <div className={styles.overrideField}>
              <label className={styles.field}>
                ...
                >
                  <option value="/demo/cco-spiral.png">Content Co-op spiral</option>
                  <option value="/demo/cco-lockup.png">Content Co-op lockup</option>
                </select>
              </label>
              <label className={styles.overrideControl}>
                <input
          ...
          <aside className={styles.previewWrap} aria-label="Resolved brand preview">
            <div className={styles.productLockupPanel} aria-label="Product lockup">
              <div className={styles.productLockupHeader}>
            ...
            <div className={styles.brandPreview} style={{ borderRadius: values.cornerRadius }}>
              <div className={styles.previewHeader}>
                <Image src={values.logoPath} alt="" width={34} height={34} />
                ...
                <span
                  ...
                  style={{
                    backgroundColor: normalizeHexColor(values.primaryColor) ?? "#0057ff",
      ...
      <SettingsSection title="Asset boundary" detail="Custom logo uploads require tenant-scoped storage and malware scanning before this control can leave demo mode.">
        <div className={styles.controlRow}>
