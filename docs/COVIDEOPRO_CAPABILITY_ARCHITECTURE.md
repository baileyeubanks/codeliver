...
```mermaid
flowchart LR
    A["Master Project Overview"] --> B["Pre-Production Studio"]
    A --> C["Production Hub"]
    A --> D["Post-Production Lab"]
    A --> E["Review Theater"]
    A --> F["Delivery Center"]
    A --> G["Asset Library"]
    A --> H["AI Toolset"]
    A --> I["Schedule and Task System"]
    A --> J["Client and Team Intelligence"]

    B --> B1["Briefs, scripts, boards, schedules, talent"]
    C --> C1["Call sheets, live media, logs, backups, crew"]
    D --> D1["Editing, versions, color, sound, captions, QC"]
    E --> E1["Comments, annotations, comparison, approval"]
    F --> F1["Formats, packaging, permissions, distribution"]
    G --> G1["Search, metadata, rights, derivatives, archive"]
    H --> H1["Assisted creation with preview and approval"]
    I --> I1["Dependencies, milestones, ownership, capacity"]
    J --> J1["Roles, clients, decisions, activity, reporting"]
```
