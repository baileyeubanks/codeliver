...
function renderEmailHtml({
  ...
  const action = resolvedActionUrl
    ? `<p style="margin-top: 20px;"><a href="${escapeHtml(resolvedActionUrl)}" style="display:inline-block;padding:10px 16px;background:#2563eb;color:#fff;text-decoration:none;border-radius:6px;">Open in Co‑ProVideo</a></p>`
    : "";
